...
Write-Host "1. Start backend: cd server then npm run dev" -ForegroundColor White
...
Write-Host "Supported: Python 3.10, Java 17, GCC 11 for C and C++" -ForegroundColor Cyan