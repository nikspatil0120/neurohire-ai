...
import { LayoutDashboard, Target, Building2, FileText, User, LogOut, Calendar, Clock, MapPin } from "lucide-react";
      ...
      <div className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <GlassCard variant="neon">
            ...
            <p className="text-3xl font-display mt-1 text-primary">2</p>
          </GlassCard>
          <GlassCard variant="neon">
            <p className="text-xs text-muted-foreground uppercase tracking-wider">Completed</p>
            <p className="text-3xl font-display mt-1 text-foreground">1</p>
          </GlassCard>
          <GlassCard variant="neon">
